...
- [x] Pipeline robuste d'ingestion (6M+ lignes)
- [x] Modélisation graphe Neo4j
- [x] Algorithme Louvain (détection communautés)
- [x] GNN GraphSAGE entraîné
- [x] Prédictions de fraude
...
**Bon travail sur ce projet d'importance ! 🚀**
 ## Team
